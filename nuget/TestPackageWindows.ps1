...
$BuildTargets = @()
$BuildTargets += New-Object PSObject -Property @{Package = "DrWavDotNet";     PlatformTarget="x64"; RID = "$OperatingSystem-x64"; }
#$BuildTargets += New-Object PSObject -Property @{Package = "DrWavDotNet";     PlatformTarget="x86"; RID = "$OperatingSystem-x86"; }
